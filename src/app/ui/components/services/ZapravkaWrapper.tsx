  ...
  return (
    <div className="wrapper py-20 md:px-5">
      ...
      <p className="my-5 text-lg font-bold">
        Наша услуга закачки краски в аэрозольный баллон — это удобное решение
        для профессионалов и любителей, которые ценят точность и комфорт при
        нанесении краски. Мы наполняем аэрозольные баллоны краской любого цвета
        и оттенка, соответствующего вашим требованиям.
      </p>
...
export default ZapravkaWrapper;
