...
const NotFound = async () => {
  return (
    <div className="w-full h-screen flex flex-row sm:flex-col items-center justify-center space-y-16 sm:space-y-0 space-x-8">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-7xl  font-bold tracking-wider text-gray-300">404</p>
